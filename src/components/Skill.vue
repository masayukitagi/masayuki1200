<template>
  <div class="skillSection">
    ...
    <div class="skillExplain">
      現在、私が持っているIT系のスキルはありません。入社後の研修で、フロントエンド側の書き方が少しずつわかってきましたが、バックエンドやデブオプスはあまり理解が及んでいないため、これから自分でも勉強しつつ、経験を積んでいきます。また、ポートフォリオ作成を通して、フロントエンド側の実装に興味を持ちました。現段階では、仕様書を参考に基礎を学んでいるので、見手の見え方や導線計画などを踏まえたデザインに時間をさくことができていないのが現状ですが、そういったデザイン面も考えながら実装できるようになることを考えると、これからがとても楽しみです。
    </div>
    <a
      class="gitHubLink"
      target="_blank"
